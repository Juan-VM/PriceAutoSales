<%-- 
    Document   : carSellingSpecifications
    Created on : 19 feb 2025, 19:57:41
            ...
            <div class="card" style="width: 18rem;">                    
                <div class="card-body">
                    <form action="createCarLogic.jsp">
                        ...
                        <div class="mb-3">
                            <select name="selModel" class="form-select" aria-label="Select your model" required>
                                ...
                                <%
                                    ...
                                    ResultSet resultset = database.getModels(selBrand);
                        ...
                        <div class="mb-3">
                            <select name="selYear" class="form-select" aria-label="Select your manufacture year" required>
                                <option value="" selected disabled>Select your manufacture year</option>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="txtEngine" required>
                        </div>  

                        <div class="mb-3">
                            <select name="selFuelType" class="form-select" aria-label="Select your fuel type" required>
                                <option value="" selected disabled>Select your fuel type</option>

                                <%
                                    database = new databaseHelper();
                                    resultset = database.getFuelTypes();
                                    while (resultset.next()) {
