    ...
    <body>   
        ...
        <div class="d-flex justify-content-center align-items-center">
            <div class="card" style="width: 18rem;">                    
                <div class="card-body">
                    <form action="carSellingSpecifications.jsp">
                        
                        <div class="mb-3">
                            <select name="selBrand" class="form-select" aria-label="Select your brand" required>
                                <option value="" selected disabled>Select your brand</option>
                                <%
                                  databaseHelper database = new databaseHelper();
                                  ResultSet resultset = database.getBrands();
